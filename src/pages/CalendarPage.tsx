            ...
            {googleConnected ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" size="sm" className="gap-1.5 text-success border-success/20 bg-success/10 hover:bg-success/20">
                    {syncing ? (
                    ...
                    {syncing ? "Sincronizando..." : googleEmail ? `Sincronizado com ${googleEmail}` : "Sincronizado"}
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onClick={disconnectGoogle} className="text-destructive">
