...
import FollowupInteligenteTab from "@/components/campaigns/FollowupInteligenteTab";
...
export default function Campaigns() {
  ...
  return (
    <div className="space-y-6" data-tour="campaigns-section">
      {/* Header */}
